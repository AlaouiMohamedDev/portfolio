...
export default function Aboutme() {
  return (
    <div className="text-Pblack h-full lg:h-screen flex flex-col items-center justify-center  w-full relative overflow-hidden font-poppins py-[70px]">
        <div className="flex items-center justify-center w-full relative">
            <h1 className='dark:text-gray-200 text-6xl font-black relative z-10'>ABOUT <c className='text-Pgreen'>ME</c></h1>
            <h1 className='text-gray-200 dark:text-gray-400/20 text-9xl font-black absolute z-2'>RESUME</h1>
        </div>
        <div className='flex items-center justify-center lg:space-y-5 2xl:space-y-10 w-full lg:space-x-10 2xl:space-x-20 lg:px-16 lg:py-16 2xl:px-32 2xl:py-24'>
            <div className='flex flex-col h-full justify-between 2xl:justify-evenly text-[15px] w-full' > 
                <h1 className='dark:text-white col-span-2 text-xl 2xl:text-2xl font-bold'>PERSONAL INFOS</h1>
                <div className='grid grid-cols-2 text-sm 2xl:text-[15px] lg:gap-x-10 2xl:gap-x-32 gap-y-5'>
            ...
            <div className="w-full grid grid-cols-2 gap-y-5 gap-x-7 2xl:gap-x-20 2xl:gap-y-10">
